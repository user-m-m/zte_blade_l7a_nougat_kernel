...
#define GPIO_CAM_FLASH_MODE 235

#define GPIO_FLASH_1W 169

int sprd_flash_on(void)
{
	printk("sprd_flash_on \n");
	gpio_request(GPIO_FLASH_1W,"cam_flash_1w");
	gpio_direction_output(GPIO_FLASH_1W, SPRD_FLASH_ON);
	gpio_free(GPIO_FLASH_1W);
...
int sprd_flash_close(void)
{
	...
	gpio_request(GPIO_FLASH_1W,"cam_flash_1w");
	gpio_direction_output(GPIO_FLASH_1W, SPRD_FLASH_OFF);
	gpio_free(GPIO_FLASH_1W);
