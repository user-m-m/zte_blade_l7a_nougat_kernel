...
//#define BMA2XX_CALI_TOLERANCE		(1000)  
...
#define	BMA2XX_ACCEL_IOCTL_BASE 77
 
#define BMA2XX_ACCEL_IOCTL_SET_DELAY		_IOW(BMA2XX_ACCEL_IOCTL_BASE, 0, int)
#define BMA2XX_ACCEL_IOCTL_GET_DELAY		_IOR(BMA2XX_ACCEL_IOCTL_BASE, 1, int)
#define BMA2XX_ACCEL_IOCTL_SET_ENABLE		_IOW(BMA2XX_ACCEL_IOCTL_BASE, 2, int)
#define BMA2XX_ACCEL_IOCTL_GET_ENABLE		_IOR(BMA2XX_ACCEL_IOCTL_BASE, 3, int)
...

{
	...
	switch(cmd)
	{
		case BMA2XX_ACCEL_IOCTL_SET_ENABLE:
            ...
            break;
        case BMA2XX_ACCEL_IOCTL_GET_ENABLE:
		    ...
		    break;
            break;
        case BMA2XX_ACCEL_IOCTL_SET_DELAY:
            if(copy_from_user(&delay, data, sizeof(delay)))
                return -EINVAL;
    		GSE_LOG("BMA2xx_ACCEL_IOCTL_SET_DELAY %u\n",delay);
            ...
            if (gsensor_set_delay(obj, obj->hw->delay) < 0)
                return -EINVAL;
            break;
        case BMA2XX_ACCEL_IOCTL_GET_DELAY:
