...
static void __sci_bm_init(void)
{
	...
	for (bm_index = AXI_BM0; bm_index < BM_SIZE; bm_index++) {
		ulong i;
		for (i = (ulong)__sci_get_bm_base(bm_index);i <= (ulong)__sci_get_bm_base(bm_index) + sizeof(struct sci_bm_reg);i = i + 4)
			__raw_writel(0, (volatile void *)(i));
	}
}
...
#if defined(CONFIG_MACH_SP7731CEA) || defined(CONFIG_MACH_SP7731CEB) || defined(CONFIG_MACH_SP7731C_3C10) || defined(CONFIG_MACH_SP7731C_10C10)
	bm_chn = 1;
#endif
...
#if defined(CONFIG_MACH_SP7731GEA) || defined(CONFIG_MACH_SP7731GEPIKE) || defined(CONFIG_MACH_SP7731GGA_LC) ||\
	defined(CONFIG_MACH_SP7731GEA_HD2) || defined(CONFIG_MACH_SP7731GEA_QHD) || defined(CONFIG_MACH_SP7731GEA_FWVGA) ||\
	defined(CONFIG_MACH_SP7731GEAOPENPHONE)
	bm_chn = 1;
#endif
